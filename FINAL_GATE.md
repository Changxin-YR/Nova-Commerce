...
| FG-09 | Inventory Concurrency | Yes | [artifacts/evidence/concurrency/fg09_inventory_over_sell.json](artifacts/evidence/concurrency/fg09_inventory_over_sell.json) | STALE | Watched paths changed since the run |
...
| FG-12 | Refund Invariants | Yes | [artifacts/evidence/integration/fg12_refund_invariants.json](artifacts/evidence/integration/fg12_refund_invariants.json) | STALE | Watched paths changed since the run |
