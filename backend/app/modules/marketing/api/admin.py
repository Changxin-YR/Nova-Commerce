...
from app.modules.marketing.api.coupons import template_data
...
@router.get("/admin/coupons", summary="List this merchant's coupon templates")
def list_admin_coupons(
    ...
    rows, total = CouponService(session).list_admin(principal=principal, page=page, page_size=page_size)
    return envelope(
        data={
